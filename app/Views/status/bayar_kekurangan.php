...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="/status_pembayaran">Status Pembayaran</a></div>
            <div class="breadcrumb-item">Status Pembayaran</div>
        </div>
    </div>
    ...
    <div class="card col-lg-8">
        <form action="/status_pembayaran/<?= $BelumLunas['id_keuangan']; ?>" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input id="jumlah_pembayaran" type="text" class="form-control" name="jumlah_pembayaran" value="<?= $tagih['jumlah_pembayaran']; ?>" readonly>
                        <div class="invalid-feedback">
