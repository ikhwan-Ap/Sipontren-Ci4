...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a href="/keamanan/add" class="btn btn-primary">Tambah</a>
        </div>
    </div>
                            ...
                            foreach ($admin as $a) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/keamanan/edit/<?= $a['username']; ?>" class="btn btn-warning">Edit</a>
                                        <a href="/keamanan/detail/<?= $a['id']; ?>" class="btn btn-info" target="_blank">Detail</a>
                                    </td>
                                </tr>
