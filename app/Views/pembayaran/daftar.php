...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a href="/pembayaran/daftar_ulang_add" class="btn btn-primary">Tambah Data </a>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="<?= base_url(); ?>/pembayaran/filter_daftar_ulang" method="POST" class="inline">
                        <?= csrf_field(); ?>
                        <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($k['status_pembayaran'] == 'Lunas') {
                                                    ...
                                                    <a href="/pembayaran/bayar_daftar_ulang/<?= $k['id_keuangan']; ?>" class="btn btn-success">Bayar</a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="/pembayaran/daftar_ulang<?= $k['id_keuangan']; ?>" method="POST">
                                                            <?= csrf_field(); ?>
