            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-dark">Data Program</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($program as $p) : ?>
                                        ...
                                        <!-- Modal delete -->
                                        <div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" id="exampleModal<?= $p['id_program']; ?>">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="/program/<?= $p['id_program']; ?>" method="POST">
                                                            <?= csrf_field(); ?>
